if SETTINGS.check_updates then
    ...
    Citizen.CreateThread( function()
      local updatePath = '/NARC-FiveM/Resources/ext-commands'
      ...
      function checkVersion(err, responseText, headers)
        ...
        elseif tonumber(curVersion) > tonumber(responseText) then
            ...
            log("Github - https://github.com/NARC-FiveM")
            log("Twitter - https://twitter.com/NorthAmericaRC")
            log("Website - https://narc.live")
            log("###############################")
